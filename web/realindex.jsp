            ...
            <li class="nav-item dropdown">
                <c:if test="${requestScope.user!=null}">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="myfavor.jsp">我的收藏</a>
                        <a class="dropdown-item" href="upload.jsp">上传</a>
                        <a class="dropdown-item" href="myphoto.jsp">我的图片</a>
                        <a class="dropdown-item" href=addfriend.jsp>加好友</a>
                        <a class="dropdown-item" href="myfriend.jsp">我的好友</a>
